...
(function () {
    ...
    const MENU_ITEMS = [
        ...
        { group: G_ANALISIS, href: '/metodologia-indicadores', icon: 'fas fa-square-root-variable', label: 'Cómo se calculan', tip: 'Metodología: la fórmula de cada indicador y su sustitución con los números reales del periodo', restricted: true },
    ...
    const MODULE_TO_HREF = {
        ...
        'metodologia': '/metodologia-indicadores',
