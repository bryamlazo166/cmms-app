...
_DEFAULT_PERMS = {
    ...
    # Rol de campo mecánico: avisos, sus OTs, lubricación e inspecciones.
    'mecanico': {
        'avisos': {'view': True, 'edit': True}, 'ordenes': {'view': True, 'edit': True},
        'compras': {'view': False, 'edit': False}, 'almacen': {'view': False, 'edit': False},
        'herramientas': {'view': True, 'edit': False}, 'lubricacion': {'view': True, 'edit': True},
    ...
    # Rol de campo eléctrico: avisos, sus OTs y rondas de medición
    # (megado/corriente/tensión en motores + monitoreo por condición).
    'electricista': {
        'avisos': {'view': True, 'edit': True}, 'ordenes': {'view': True, 'edit': True},
        'compras': {'view': False, 'edit': False}, 'almacen': {'view': False, 'edit': False},
