...
def register_lubrication_routes(
    ...
    def handle_lubrication_points():
        ...
        for p in points:
            d = p.to_dict()
            # Refresh semaphore dynamically
            next_due, semaphore = _calculate_lubrication_schedule(d.get("last_service_date"), d.get("frequency_days"), d.get("warning_days"))
    ...
    def handle_lubrication_point_id(point_id):
        ...
        try:
            ...
            next_due, semaphore = _calculate_lubrication_schedule(point.last_service_date, point.frequency_days, point.warning_days)
    ...
    def get_lubrication_dashboard():
        try:
            ...
            items = []
            for p in points:
                next_due, semaphore = _calculate_lubrication_schedule(p.last_service_date, p.frequency_days, p.warning_days)
            ...
            items.sort(key=lambda r: (r["next_due_date"] or "9999-12-31"))
