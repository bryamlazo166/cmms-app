...
def register_auth_routes(app, db, logger, User, RolePermission=None):
    ...
    MODULES = [
        ...
        {'key': 'martillos', 'label': 'Martillos FAPMETAL'},
        ...
        {'key': 'produccion', 'label': 'Produccion vs Mtto'},
        {'key': 'paradas', 'label': 'Paradas de Planta'},
        {'key': 'plantillas_paradas', 'label': 'Plantillas de Paradas'},
        {'key': 'programa_nocturno', 'label': 'Programa Nocturno'},
        {'key': 'flujo_planta', 'label': 'Flujo de Planta'},
        {'key': 'perdidas_produccion', 'label': 'Perdidas de Produccion'},
        {'key': 'insights', 'label': 'Insights / Optim. Preventivos'},
        {'key': 'seguimiento', 'label': 'Seguimiento'},
        {'key': 'calendario', 'label': 'Calendario Mantenimiento'},
